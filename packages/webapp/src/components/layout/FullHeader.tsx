    ...
    <header className="shadow-[0_0.5rem_1rem_rgba(0,0,0,0.15)]">
      ...
      <div className="bg-accent">
        <div className="max-w-screen-xl mx-auto px-[18px] flex items-center justify-between h-12">
          ...
          <div className="flex items-center gap-4 text-accent-content">
            ...
            {user ? (
              <span className="flex items-center gap-3">
                <span className="hidden sm:inline text-sm text-accent-content">
                  {user.name}
                </span>
                <button
                  type="button"
                  className="text-sm text-accent-content hover:text-accent-content bg-transparent border-none cursor-pointer transition-colors duration-150 p-0"
      ...
      <div className="bg-primary relative">
        <div className="max-w-screen-xl mx-auto px-[18px] flex items-center h-12">
          ...
          {/* Desktop nav */}
          <nav className="hidden lg:block w-full" aria-label="Navigazione principale">
